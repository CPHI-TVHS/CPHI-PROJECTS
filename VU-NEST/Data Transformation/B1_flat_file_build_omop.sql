...
Using OMOPV5. schema for OMOP table name. can search and replace schema

med build line 1020
lab build line 1075
main build line 1670
final build line 1880

/*
***************** 12/10/2020 changes **********************
1. line 70; Remove 57220 CPT
2. line 549; Remove 70.51 ICD
3. line 1731; Add additional union to capture Condition on Condition_concept_id
4. line 1778; Add additional Union to capture Observation on Observation_concept_id
5. line 2072; Menopause logic change; > 51 at time of surgery then default menopause to 1
----------------------------------------------------------->
***************** 10/22/2020 Cornell changes ***************** 
1. line 7265
	- add year_of_birth
	- add month_of_birth
	- add day_of_birth
2. line 1897
	- cornell reported no source concept id for Weight and Height. Only marked as 'Weight' and 'Height' in measurement_source_value
3. line 2260
	- PreAbsurg, PeriAbsurg, PostAbsurg change to binary
*/
...
INSERT INTO #Temp_Appendix_Import VALUES ('Covariate','BMI','LOINC','39156-5');

INSERT INTO #Temp_Appendix_Import VALUES ('Covariate','Weight','VUMC Labs','Weight');
INSERT INTO #Temp_Appendix_Import VALUES ('Covariate','Weight','LOINC','29463-7');
INSERT INTO #Temp_Appendix_Import VALUES ('Covariate','Weight','LOINC','8340-2');

INSERT INTO #Temp_Appendix_Import VALUES ('Covariate','Height','VUMC','Height');
INSERT INTO #Temp_Appendix_Import VALUES ('Covariate','Height','LOINC','8301-4');
INSERT INTO #Temp_Appendix_Import VALUES ('Covariate','Height','LOINC','8302-2');

INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','CPT4','99406');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','CPT4','99407');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','HCPCS','G0375');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','HCPCS','G0376');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','SNOMED','160617001');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','SNOMED','160625004');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','SNOMED','266918002');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','SNOMED','266919005');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','HCPCS','G0437');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','HCPCS','G0436');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','O99.333');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','O99.334');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','Z53.01');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','O99.332');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','T65.222A');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','T65.224S');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','O99.330');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','T65.221A');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','T65.221S');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','T65.224A');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','O99.331');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','ICD10CM','O99.335');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','HCPCS','G9458');
INSERT INTO #Temp_Appendix_Import VALUES('Covariate','Smoking','CPT4','31');



/**********************************************************
No codes were provided in data dictionary for some Covariates. 
Need to search each domain to find which codes are used for each unknown Covariates.
**********************************************************/

-------------------------- Menopause
INSERT INTO #Temp_Appendix_Import
SELECT 'Covariates'
,'Menopause'
, b.vocabulary_id
, b.concept_code
FROM OMOPV5.condition_occurrence as a
    JOIN OMOPV5.CONCEPT as b
      ON a.condition_concept_id = b.concept_id
WHERE lower(b.concept_name) like '%menopausal%'
GROUP BY b.vocabulary_id
, b.concept_code
UNION
SELECT 'Covariates'
,'Menopause'
...
FROM OMOPV5.condition_occurrence as a
    JOIN OMOPV5.CONCEPT as b
      ON a.condition_concept_id = b.concept_id
WHERE lower(concept_name) like '%diabetes mellitus%'
GROUP BY b.vocabulary_id
, b.concept_code
UNION
SELECT 'Covariates'
...
FROM OMOPV5.observation as a
    JOIN OMOPV5.CONCEPT as b
      ON a.observation_concept_id = b.concept_id
WHERE (lower(concept_name) like '%diabetes mellitus%') and lower(concept_name) not like '%family history%'
GROUP BY b.vocabulary_id
, b.concept_code
UNION
SELECT 'Covariates'
...
, b.vocabulary_id
, b.concept_code
FROM OMOPV5.procedure_occurrence as a
    JOIN OMOPV5.CONCEPT as b
...
FROM OMOPV5.condition_occurrence as a
    JOIN OMOPV5.CONCEPT as b
      ON a.condition_concept_id = b.concept_id
WHERE lower(concept_name) like '%coronary artery disease%'
GROUP BY b.vocabulary_id
, b.concept_code
UNION
SELECT 'Covariates'
...
FROM OMOPV5.condition_occurrence as a
    JOIN OMOPV5.CONCEPT as b
      ON a.condition_concept_id = b.concept_id
  WHERE lower(concept_name) like '%peripheral vascular disease%'
GROUP BY b.vocabulary_id
, b.concept_code
UNION
SELECT 'Covariates'
...
FROM OMOPV5.condition_occurrence as a
    JOIN OMOPV5.CONCEPT as b
      ON a.condition_concept_id = b.concept_id
WHERE lower(concept_name) like '%hyperlipidemia%'
GROUP BY b.vocabulary_id
, b.concept_code
UNION
SELECT 'Covariates'
...
FROM OMOPV5.observation as a
    JOIN OMOPV5.CONCEPT as b
      ON a.observation_concept_id = b.concept_id
WHERE lower(concept_name) like '%pain score%'
GROUP BY b.vocabulary_id
, b.concept_code;
...
if OBJECT_ID('tempdb..#Temp_Drug_Class') IS NOT NULL drop table #Temp_Drug_Class
SELECT Ancestor.concept_id as Class_Concept_Id
,Ancestor.concept_name as Class_Name
,Ancestor.concept_code as Class_Code
,CC.concept_class_name as Classification
,Ancestor.vocabulary_id as Class_vocabulary_id
,V.vocabulary_name as Class_vocabulary_name
,Descendant.concept_id as descendant_concept_id
,Descendant.concept_name as descendant_name
INTO #Temp_Drug_Class
FROM OMOPV5.concept_ancestor as CA
  JOIN OMOPV5.concept as Ancestor
    on CA.ancestor_concept_id = Ancestor.concept_id
  JOIN OMOPV5.vocabulary V
    on Ancestor.vocabulary_id = V.vocabulary_id
  JOIN OMOPV5.concept_class CC
    ON Ancestor.concept_class_id = cc.concept_class_id
  JOIN OMOPV5.concept as Descendant
    on CA.descendant_concept_id = descendant.concept_id
WHERE  cc.concept_class_name = 'ATC 4th Level'
AND getdate() BETWEEN Ancestor.valid_start_date AND Ancestor.valid_end_date;
...
if OBJECT_ID('tempdb..#Temp_TopMedClass') IS NOT NULL drop table #Temp_TopMedClass;
WITH cte_drugs as
(

	SELECT person_id
	, procedure_date
	, max(drug_exposure_end_date) as drug_exposure_end_date
	, drug_concept_id
	, concept_name
	FROM
	(
		SELECT b.person_id
		, b.procedure_date
		, CASE WHEN DRUG_EXPOSURE_END_DATE IS NOT NULL THEN DRUG_EXPOSURE_END_DATE
			WHEN DAYS_SUPPLY IS NOT NULL OR DAYS_SUPPLY > 0 THEN DATEADD(day,DAYS_SUPPLY,DRUG_EXPOSURE_START_DATE) 
			ELSE DATEADD(DAY,1,DRUG_EXPOSURE_START_DATE) END AS [DRUG_EXPOSURE_END_DATE]
		, a.drug_concept_id
		, c.concept_name
		FROM OMOPV5.DRUG_EXPOSURE as a
		JOIN #MESH_SLING as b
			ON a.person_id = b.person_id
		JOIN OMOPV5.concept as c
			ON a.drug_concept_id = c.concept_id
		WHERE drug_concept_id > 0          
	) as drug_table
	WHERE drug_exposure_end_date <= procedure_date
		AND DATEDIFF(day,drug_exposure_end_date, procedure_date)<= 182
		AND drug_exposure_end_date <= DATEADD(DAY,2,procedure_date)
	GROUP BY person_id
	, procedure_date
	, drug_concept_id
	, concept_name
)
SELECT top(50)'Covariate' as Category
, 'ATC_'+ replace(replace(replace(replace(replace(replace(b.class_name,' ','_'),',',''),'.',''),'(',''),')',''),'-','_') as Descriptive
, Class_Concept_Id as Concept_id
, count(distinct person_id) as distinct_patient_count
, count(person_id) as record_count
, count(distinct person_id) * 100 / (SELECT count(distinct person_id) FROM #MESH_SLING) as distinct_patient_PCT 
INTO #Temp_TopMedClass
FROM cte_drugs as a
JOIN #Temp_Drug_Class as b
	ON a.drug_concept_id = b.descendant_concept_id
GROUP BY Class_Concept_Id
, class_name
, class_code
, class_vocabulary_id
...
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('moderate',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES (' small',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('trace',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('/',0);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('small',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES (' large',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('large',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES (' moderate',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('credited',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('3+',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('1+',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('unable to confirm du',0);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('2+',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('mislabeled specimen:',0);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES (' trace',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('moderate (2+)',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('small (1+)',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('negative',0);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('positive',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES (' positive',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('/',0);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('credited',1);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('see comment',0);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('unable to confirm du',0);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('interfering substanc',0);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('see',0);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('not',0);
INSERT INTO #Temp_Lab_sourcevalue_map VALUES ('mislabeled specimen:',0);
...
if OBJECT_ID('tempdb..#MESH_APPENDIX') IS NOT NULL drop table #MESH_APPENDIX
	...
	, condition.condition_start_date as valuedate
	, CONCEPT.vocabulary_id
	, CONCEPT.concept_code
	, CONCEPT.concept_name
	, NULL as ValueAsNumber
	, condition.condition_source_value as SourceValue
	, 'Condition_Occurrence' as TableName
	, condition_occurrence_id as Primary_id
	, NULL as Drug_Class_id
	, NULL as Drug_Concept_id
	, NULL as unit_source_value
	INTO #MESH_APPENDIX
	FROM #Temp_Appendix_Import as Import
	LEFT JOIN OMOPV5.CONCEPT as CONCEPT
		ON Import.codetype = CONCEPT.vocabulary_id
		and Import.code = CONCEPT.concept_code
	JOIN OMOPV5.condition_occurrence as condition
		ON condition.condition_source_concept_id = concept.concept_id
	JOIN #MESH_SLING as MESH_SLING
		ON condition.person_id = MESH_SLING.person_id
UNION
	SELECT Import.descriptive
	, MESH_SLING.person_id
	, MESH_SLING.procedure_date
...
UNION
	...
	, MESH_SLING.person_id
	, MESH_SLING.procedure_date
	, procedure_table.procedure_date as valuedate
	, CONCEPT.vocabulary_id
	, CONCEPT.concept_code
	, CONCEPT.concept_name
	, NULL as ValueAsNumber
	, procedure_table.procedure_source_value
	, 'Procedure_Occurrence' as TableName
	, Procedure_occurrence_id as Primary_id
	, NULL as Drug_Class_id
	, NULL as Drug_Concept_id
	, NULL as unit_source_value
	FROM #Temp_Appendix_Import as Import
	LEFT JOIN OMOPV5.CONCEPT as CONCEPT
		ON Import.codetype = CONCEPT.vocabulary_id
		and Import.code = CONCEPT.concept_code
	JOIN OMOPV5.procedure_occurrence as procedure_table
		ON procedure_table.procedure_source_concept_id = concept.concept_id
	JOIN #MESH_SLING as MESH_SLING
		ON procedure_table.person_id = MESH_SLING.person_id        
UNION 
	SELECT Import.descriptive
	, MESH_SLING.person_id
	, MESH_SLING.procedure_date
	, observation.observation_date as valuedate
	, CONCEPT.vocabulary_id
	, CONCEPT.concept_code
	, CONCEPT.concept_name
	, observation.value_as_number as ValueAsNumber
	, observation.observation_source_value
	, 'Observation' as TableName
	, Observation_id as Primary_id
	, NULL as Drug_Class_id
	, NULL as Drug_Concept_id
	, NULL as unit_source_value
	FROM #Temp_Appendix_Import as Import
	LEFT JOIN OMOPV5.CONCEPT as CONCEPT
		ON Import.codetype = CONCEPT.vocabulary_id
		and Import.code = CONCEPT.concept_code
	JOIN OMOPV5.observation as observation
		ON observation.observation_source_concept_id = concept.concept_id
	JOIN #MESH_SLING as MESH_SLING
		ON observation.person_id = MESH_SLING.person_id
UNION 
	SELECT Import.descriptive
	, MESH_SLING.person_id
	, MESH_SLING.procedure_date
...
UNION 
	...
	, MESH_SLING.person_id
	, MESH_SLING.procedure_date
	, measurement.measurement_date as valuedate
	, CONCEPT.vocabulary_id
	, CONCEPT.concept_code
	, CONCEPT.concept_name
	, measurement.value_as_number as ValueAsNumber
	, measurement.measurement_source_value
	, 'Measurement' as TableName
	, measurement_id as Primary_id
	, NULL as Drug_Class_id
	, NULL as Drug_Concept_id
	, unit_source_value
	FROM #Temp_Appendix_Import as Import
	LEFT JOIN OMOPV5.CONCEPT as CONCEPT
		ON Import.codetype = CONCEPT.vocabulary_id
		and Import.code = CONCEPT.concept_code
	JOIN OMOPV5.measurement as measurement
		ON measurement.measurement_source_concept_id = concept.concept_id
	JOIN #MESH_SLING as MESH_SLING
		ON measurement.person_id = MESH_SLING.person_id
	WHERE measurement_datetime < MESH_SLING.procedure_date   
UNION
	SELECT 'Visit_Post'
	, MESH_SLING.person_id
	, MESH_SLING.procedure_date
	, visit_post.visit_start_date as valuedate
	...
	,NULL as SourceValue
	,'Visit' as TableName
	, Visit_occurrence_id as Primary_id
	, NULL as Drug_Class_id
	, NULL as Drug_Concept_id
	, NULL as unit_source_value
	FROM #MESH_SLING as MESH_SLING
	JOIN OMOPV5.VISIT_OCCURRENCE as visit_post
		ON MESH_SLING.person_id = visit_post.person_id
		AND MESH_SLING.procedure_date < visit_post.visit_start_date
		AND datediff(day,MESH_SLING.procedure_date, visit_post.visit_start_date) <= 365
UNION
	SELECT 'Visit_Prior'
	, MESH_SLING.person_id
	, MESH_SLING.procedure_date
	, visit_prior.visit_start_date as valuedate
	,NULL as Vocabulary_id
	,NULL as Concept_code
	,NULL as Concept_name
	,NULL as ValueAsNumber
	...
	, NULL as unit_source_value
	FROM #MESH_SLING as MESH_SLING 
	JOIN OMOPV5.VISIT_OCCURRENCE as visit_prior
		ON visit_prior.person_id = MESH_SLING.person_id
		AND visit_prior.visit_start_date < MESH_SLING.procedure_date
		AND datediff(day,visit_prior.visit_start_date,MESH_SLING.procedure_date) <= 365
UNION
	SELECT *
	FROM
	( 
		...
		, CASE WHEN DRUG_EXPOSURE_END_DATE IS NOT NULL THEN DRUG_EXPOSURE_END_DATE
			WHEN DAYS_SUPPLY IS NOT NULL OR DAYS_SUPPLY > 0 THEN DATEADD(day,DAYS_SUPPLY,DRUG_EXPOSURE_START_DATE) 
			ELSE DATEADD(DAY,1,DRUG_EXPOSURE_START_DATE) END AS value_date
		,NULL as Vocabulary_id
		,NULL as Concept_code
		,NULL as Concept_name
		,NULL as ValueAsNumber
		,NULL as SourceValue
		,'Drug' as TableName
		,drug_exposure_id as Primary_id
		,drug_class.class_concept_id
		,drug.drug_concept_id
		, NULL as unit_source_value
		FROM #MESH_SLING as MESH_SLING 
		JOIN OMOPV5.drug_exposure as drug
			ON drug.person_id = MESH_SLING.person_id
		JOIN #Temp_Drug_Class as drug_class
			ON drug.drug_concept_id = drug_class.descendant_concept_id
		JOIN #Temp_TopMedClass as topmed
		ON topmed.concept_id= drug_class.class_concept_id
	) as a
	WHERE value_date < procedure_date
	AND datediff(day,value_date,procedure_date) <= 182

UNION 
	SELECT CONCEPT.labtestabbr
	, MESH_SLING.person_id
	, MESH_SLING.procedure_date
	, measurement.measurement_date as valuedate
	,NULL as Vocabulary_id
	,NULL as Concept_code
	,NULL as Concept_name
	, CASE when measurement.value_as_number is null and map.ValueAsNumber is not null THEN map.ValueAsNumber
	ELSE measurement.value_as_number END as ValueAsNumber
	,measurement.value_source_value as SourceValue
	, 'Measurement' as TableName
	, measurement_id as Primary_id
	, NULL as Drug_Class_id
	, NULL as Drug_Concept_id
	, NULL as unit_source_value
	FROM OMOPV5.measurement as measurement
	JOIN #MESH_SLING as MESH_SLING
	ON measurement.person_id = MESH_SLING.person_id
	JOIN (
			SELECT a.labtestabbr
			, b.codevalue
			, c.concept_id
			, c.vocabulary_id
			FROM #LABTESTS_LOINC_KEY as a
			JOIN #LABTESTS_LOINC_CODES as b
			ON a.labtestid = b.labtestid
			JOIN OMOPV5.CONCEPT c
			ON b.codevalue = c.concept_code  
		) as CONCEPT
	ON measurement.measurement_concept_id = CONCEPT.concept_id
	LEFT JOIN #Temp_Lab_sourcevalue_map as map
		ON map.value_source_value = lower(measurement.value_source_value)
...
UNION 
	...
	,NULL as Concept_code
	,NULL as Concept_name
	,measurement.value_as_number END as ValueAsNumber
	,measurement.value_source_value as SourceValue
	,'Measurement' as TableName
	, measurement_id as Primary_id
	, NULL as Drug_Class_id
...
UNION
	...
	JOIN #MESH_SLING as MESH_SLING
		ON measurement.person_id = MESH_SLING.person_id
	WHERE measurement_source_value ='HEIGHT'
;
...
, MESH_PERSON.birth_datetime as DateTimeBirth
, death.DEATH_DATE as DateTimeDeath
, MESH_SLING.procedure_date as DateTimeSurgery
, max(inpat_follow.visit_end_date) as inpat_follow
, max(outpat_follow.visit_end_date) as outpat_follow
...
, CASE WHEN MESH_PERSON.gender_concept_id = 8532 THEN 1 ELSE 0 END as Female
, race_concept.concept_name as Race
, CASE WHEN MESH_PERSON.ethnicity_concept_id = 38003563 THEN 1 ELSE 0 END as Hispanic

INTO #MESH_FINAL0
FROM #MESH_SLING as MESH_SLING
JOIN OMOPV5.person as MESH_PERSON
  ON MESH_SLING.person_id = MESH_PERSON.person_id

LEFT JOIN OMOPV5.death as death
  ON MESH_SLING.person_id = death.person_id

LEFT JOIN OMOPV5.CONCEPT as race_concept
  ON MESH_PERSON.race_concept_id = race_concept.concept_id

LEFT JOIN OMOPV5.VISIT_OCCURRENCE as inpat_follow
  ON MESH_SLING.person_id = inpat_follow.person_id
  and inpat_follow.visit_concept_id = 9201
  and inpat_follow.visit_end_date > MESH_SLING.procedure_date
  and datediff(DAY, MESH_SLING.procedure_date, inpat_follow.visit_end_date) > 365  

LEFT JOIN OMOPV5.VISIT_OCCURRENCE as outpat_follow
  ON MESH_SLING.person_id = outpat_follow.person_id
  and outpat_follow.visit_concept_id = 9202
  and outpat_follow.visit_end_date > MESH_SLING.procedure_date
  and datediff(day,MESH_SLING.procedure_date, outpat_follow.visit_end_date) > 365  
...
GROUP BY
  MESH_PERSON.birth_datetime
, death.DEATH_DATE
, MESH_PERSON.gender_concept_id
, MESH_PERSON.ethnicity_concept_id
, race_concept.concept_name
, MESH_SLING.person_id
, MESH_SLING.procedure_date
, NON_SLING.person_id
, LAP_SLING.person_id
...
day(DATIMETIMEBIRTH) as day_of_birth,
DATETIMEDEATH,
DATETIMESURGERY,
INPAT_FOLLOW,
OUTPAT_FOLLOW,
